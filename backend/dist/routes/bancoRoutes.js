...
const bancoController = __importStar(require("../controllers/bancoController"));
const auth_1 = require("../middleware/auth");
const router = express_1.default.Router();
// Todas as rotas requerem autenticação de administrador
router.use(auth_1.verificarToken, auth_1.verificarAdmin);
// Saldo mensal
...
//# sourceMappingURL=bancoRoutes.js.map